...
usage(){
    ...
    echo "  --dont-use-carthage                     Use classic repo build instead of cocoa pods binary via carthage"
...
while [ "$1" != "" ]; do
    case $1 in
        ...
        -c | --clean-output )   clean_output=1
                                ;;
        --dont-use-carthage )   dont_use_carthage=1
                                ;;
        -s | --sharpie )        sharpie=1
                                ;;
        -v | --verbose )        verbose=1
