...
{
    public class DfuProgressListener : Laerdal.Xamarin.Dfu.Droid.DfuProgressListenerAdapter
    {
        ...
        public DfuProgressListener(DfuInstallation dfuInstallation)
        {
            ...
            Laerdal.Xamarin.Dfu.Droid.DfuServiceListenerHelper.RegisterProgressListener(Application.Context, this);
        }

        protected override void Dispose(bool disposing)
        {
            Laerdal.Xamarin.Dfu.Droid.DfuServiceListenerHelper.UnregisterProgressListener(Application.Context, this);
